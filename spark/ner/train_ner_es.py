...
def start_spark(jar_file, driver_memory="64G", log_level="WARN"):
...
nerTagger = NerDLApproach()\
    ...
    .setTestDataset("test_withEmbeds_es.parquet")

# Test dataset
test_data = CoNLL(conllLabelIndex=2).readDataset(spark, './esp.testa')
