...
class Parser(ArgumentParser):
    ...
    arguments to the parser after initialization and you'll get the output back after parsing as an additional namespace.
    """
    ...
    def parse_args_into_dataclasses(
        ...
        if args_filename or (look_for_args_file and len(sys.argv)):
            ...
            if args_file.exists():
                ...
                # in case of duplicate arguments the first one has precedence so we append rather than prepend.
