#!/bin/bash
#SBATCH -D .
#SBATCH --job-name=/gpfs/projects/bsc88/projects/intelcomp/T3.1_NLP_in_HPC/official_github/NLP_pipeline/hpc/sbatch/patstat/sbatch_execution_2
...
bash ../../run.sh "toy_data//patstat/part_0004.parquet"
