#!/bin/bash
#SBATCH -D .
#SBATCH --job-name=/gpfs/projects/bsc88/projects/intelcomp/T3.1_NLP_in_HPC/official_github/NLP_pipeline/hpc/sbatch/semantic/sbatch_execution_5
...
bash ../../run.sh "toy_data//semantic/part-00003-13434629-9129-4b93-9f8a-f4b75b6b8d2a-c000.snappy.parquet"
